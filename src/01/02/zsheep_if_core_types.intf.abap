INTERFACE zsheep_if_core_types
  PUBLIC.
  ...
  TYPES:
    BEGIN OF ty_s_bind_config,
      ...
      view               TYPE string,
      custom_mapper      TYPE REF TO zsheep_if_ajson_mapping,
      custom_mapper_back TYPE REF TO zsheep_if_ajson_mapping,
      custom_filter      TYPE REF TO zsheep_if_ajson_filter,
      custom_filter_back TYPE REF TO zsheep_if_ajson_filter,
  ...
  TYPES:
    BEGIN OF ty_s_attri,
      ...
      view               TYPE string,
      json_bind_local    TYPE REF TO zsheep_if_ajson,
      custom_filter      TYPE REF TO zsheep_if_ajson_filter,
      custom_filter_back TYPE REF TO zsheep_if_ajson_filter,
      custom_mapper      TYPE REF TO zsheep_if_ajson_mapping,
      custom_mapper_back TYPE REF TO zsheep_if_ajson_mapping,
  ...
  TYPES:
    BEGIN OF ty_s_next_frontend,
      ...
      handler_attrs TYPE zsheep_if_types=>ty_s_http_handler_attributes,
    END OF ty_s_next_frontend.

  TYPES:
    BEGIN OF ty_s_next,
      o_app_call  TYPE REF TO zsheep_if_app,
      o_app_leave TYPE REF TO zsheep_if_app,
  ...
  TYPES:
    BEGIN OF ty_s_http_request_post,
      o_model TYPE REF TO zsheep_if_ajson,
      BEGIN OF s_front,
        id          TYPE string,
        view        TYPE string,
        t_event_arg TYPE string_table,
        event       TYPE string,
        o_comp_data TYPE REF TO zsheep_if_ajson,
        origin      TYPE string,
  ...
  TYPES:
    BEGIN OF ty_s_config,
      ...
      pathname         TYPE string,
      search           TYPE string,
      t_startup_params TYPE zsheep_if_types=>ty_t_name_value,
    END OF ty_s_config.
  ...
  TYPES ty_s_db TYPE zsheep_t_01.
