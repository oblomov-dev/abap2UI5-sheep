CLASS zsheep_cl_core_client DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.

    INTERFACES zsheep_if_client .

    DATA mo_action TYPE REF TO zsheep_cl_core_action.

    METHODS constructor
      IMPORTING
        !action TYPE REF TO zsheep_cl_core_action.
...
CLASS zsheep_cl_core_client IMPLEMENTATION.
  ...
  METHOD zsheep_if_client~follow_up_action.
  ...
  METHOD zsheep_if_client~get_event_arg.
  ...
  METHOD zsheep_if_client~get_app.

    IF id IS NOT INITIAL.
      DATA(lo_app) = zsheep_cl_core_app=>db_load( id ).
  ...
  METHOD zsheep_if_client~message_box_display.
  ...
  METHOD zsheep_if_client~message_toast_display.
  ...
  METHOD zsheep_if_client~nav_app_call.

    IF app IS NOT BOUND.
      zsheep_cl_util=>x_raise( `NAV_APP_LEAVE_TO_INITIAL_APP_ERROR` ).
    ENDIF.

    mo_action->ms_next-o_app_call = app.

    IF app->id_app IS INITIAL.
      app->id_app = zsheep_cl_util=>uuid_get_c32( ).
    ENDIF.
    result = app->id_app.
  ENDMETHOD.


  METHOD zsheep_if_client~nav_app_leave.

    IF app IS NOT SUPPLIED.
      app = zsheep_if_client~get_app( zsheep_if_client~get( )-s_draft-id_prev_app_stack ).
    ENDIF.
  ...
  METHOD zsheep_if_client~nest2_view_destroy.
  ...
  METHOD zsheep_if_client~nest2_view_display.
  ...
  METHOD zsheep_if_client~nest2_view_model_update.
  ...
  METHOD zsheep_if_client~nest_view_destroy.
  ...
  METHOD zsheep_if_client~nest_view_display.
  ...
  METHOD zsheep_if_client~nest_view_model_update.
  ...
  METHOD zsheep_if_client~popover_destroy.
  ...
  METHOD zsheep_if_client~popover_display.
  ...
  METHOD zsheep_if_client~popover_model_update.
  ...
  METHOD zsheep_if_client~popup_destroy.
  ...
  METHOD zsheep_if_client~popup_display.
  ...
  METHOD zsheep_if_client~popup_model_update.
  ...
  METHOD zsheep_if_client~view_destroy.
  ...
  METHOD zsheep_if_client~view_display.
  ...
  METHOD zsheep_if_client~view_model_update.
  ...
  METHOD zsheep_if_client~_bind.

    DATA(lo_bind) = NEW zsheep_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = zsheep_cl_util=>conv_get_as_data_ref( val )
      type   = zsheep_if_core_types=>cs_bind_type-one_way
      config = VALUE #(
         path_only     = path
         custom_filter = custom_filter
         custom_mapper = custom_mapper
         tab           = zsheep_cl_util=>conv_get_as_data_ref( tab )
         tab_index     = tab_index ) ).

  ENDMETHOD.


  METHOD zsheep_if_client~_bind_edit.

    DATA(lo_bind) = NEW zsheep_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = zsheep_cl_util=>conv_get_as_data_ref( val )
      type   = zsheep_if_core_types=>cs_bind_type-two_way
      config = VALUE #(
         path_only          = path
         custom_filter      = custom_filter
  ...
  METHOD zsheep_if_client~_bind_local.
  ...
  METHOD zsheep_if_client~_event.

    DATA(lo_ui5) = NEW zsheep_cl_core_event_srv( ).
  ...
  METHOD zsheep_if_client~_event_client.
  ...
  METHOD zsheep_if_client~set_session_stateful.

    DATA(lv_check_sticky) =  CAST zsheep_if_app( mo_action->mo_app->mo_app )->check_sticky.
    ...
    IF stateful = abap_true.
      ...
      CAST zsheep_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_true.
    ELSE.
      mo_action->ms_next-s_set-handler_attrs-stateful-active = 0.
      CAST zsheep_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
    ENDIF.
