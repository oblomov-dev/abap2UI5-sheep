...
CLASS zsheep_cl_core_diss_srv DEFINITION LOCAL FRIENDS ltcl_test_dissolve.
...
CLASS ltcl_test_dissolve IMPLEMENTATION.
  ...
  METHOD test_ref.
    ...
    DATA lt_attri TYPE zsheep_if_core_types=>ty_t_attri.
    DATA(lo_model) = NEW zsheep_cl_core_diss_srv(
      attri = REF #( lt_attri )
      app   = lo_app ).
