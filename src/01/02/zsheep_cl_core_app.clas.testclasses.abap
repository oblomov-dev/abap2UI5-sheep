...
CLASS zsheep_cl_core_app DEFINITION LOCAL FRIENDS ltcl_test.

CLASS ltcl_test IMPLEMENTATION.

  METHOD first_test.

    DATA(lo_action) = NEW zsheep_cl_core_app( ) ##NEEDED.
...
CLASS ltcl_test_db IMPLEMENTATION.
  ...
  METHOD test_db_save.
    ...
    DATA(lo_app_db) = zsheep_cl_core_app=>db_load( `TEST_ID` ).
