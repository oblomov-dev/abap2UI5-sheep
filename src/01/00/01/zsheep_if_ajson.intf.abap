INTERFACE zsheep_if_ajson
  ...
  DATA mt_json_tree TYPE zsheep_if_ajson_types=>ty_nodes_ts READ-ONLY.

  " CLONING

  METHODS clone
    RETURNING
      VALUE(ri_json) TYPE REF TO zsheep_if_ajson
    RAISING
  ...
  METHODS get_node_type
    IMPORTING
      iv_path TYPE string
    RETURNING
      VALUE(rv_node_type) TYPE zsheep_if_ajson_types=>ty_node_type.
  ...
  METHODS set
    IMPORTING
      ...
      iv_node_type TYPE zsheep_if_ajson_types=>ty_node_type OPTIONAL
    RETURNING
      VALUE(ri_json) TYPE REF TO zsheep_if_ajson
    RAISING
      zsheep_cx_ajson_error.
