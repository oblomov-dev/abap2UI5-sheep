CLASS zsheep_cl_pop_file_dl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO zsheep_cl_pop_file_dl.
...
CLASS zsheep_cl_pop_file_dl IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    IF mv_check_download = abap_true.
      DATA(lv_csv_x) = zsheep_cl_util=>conv_get_xstring_by_string( mv_value ).
      DATA(lv_base64) = zsheep_cl_util=>conv_encode_x_base64( lv_csv_x ).
