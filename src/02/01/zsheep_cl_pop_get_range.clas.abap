CLASS zsheep_cl_pop_get_range DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zsheep_cl_pop_get_range.

    TYPES:
      BEGIN OF ty_s_result,
        t_range         TYPE zsheep_cl_util=>ty_t_range,
    ...
    DATA mt_mapping TYPE zsheep_if_types=>ty_t_name_value.
  PROTECTED SECTION.
...
CLASS zsheep_cl_pop_get_range IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    zsheep_cl_util=>itab_corresponding(
      EXPORTING
        val = t_range
      CHANGING
  ...
  METHOD zsheep_if_app~main.
    ...
    IF check_initialized = abap_false.
      ...
      mt_mapping = zsheep_cl_util=>filter_get_token_range_mapping( ).
      ...
      LOOP AT ms_result-t_range REFERENCE INTO DATA(lr_product).
        INSERT VALUE #(
                 ...
                 key    = zsheep_cl_util=>uuid_get_c32( )
    ...
    CASE client->get( )-event.
      ...
      WHEN `POPUP_ADD`.
        INSERT VALUE #( key = zsheep_cl_util=>uuid_get_c32( ) ) INTO TABLE mt_filter.
