CLASS zsheep_cl_pop_js_loader DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zsheep_cl_pop_js_loader.
...
CLASS zsheep_cl_pop_js_loader IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(popup) = zsheep_cl_xml_view=>factory_popup( )->dialog( `Setup UI...`
        )->content( ).
