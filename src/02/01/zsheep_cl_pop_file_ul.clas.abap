CLASS zsheep_cl_pop_file_ul DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO zsheep_cl_pop_file_ul.
...
CLASS zsheep_cl_pop_file_ul IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(popup) = zsheep_cl_xml_view=>factory_popup( )->dialog(
                  title       = title
                  icon        = icon
  ...
  METHOD zsheep_if_app~main.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data2) = zsheep_cl_util=>conv_decode_x_base64( lv_data ).
        ms_result-value = zsheep_cl_util=>conv_get_string_by_xstring( lv_data2 ).
