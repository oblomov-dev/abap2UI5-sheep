CLASS zsheep_cl_pop_get_range_m DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zsheep_cl_pop_get_range_m.

    TYPES:
      BEGIN OF ty_s_result,
        t_filter        TYPE zsheep_cl_util=>ty_t_filter_multi,
...
CLASS zsheep_cl_pop_get_range_m IMPLEMENTATION.
  ...
  METHOD popup_display.
    ...
    DATA(lo_popup) = zsheep_cl_xml_view=>factory_popup( ).
  ...
  METHOD zsheep_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      ...
      DATA(lo_popup) = CAST zsheep_cl_pop_get_range( client->get_app( client->get( )-s_draft-id_prev_app ) ).
      IF lo_popup->result( )-check_confirmed = abap_true.
        ...
        <tab>-t_token = zsheep_cl_util=>filter_get_token_t_by_range_t( <tab>-t_range ).
      ENDIF.
      popup_display( ).
    ...
    CASE client->get( )-event.
      ...
      WHEN 'LIST_OPEN'.
        ...
        client->nav_app_call( zsheep_cl_pop_get_range=>factory( ls_sql-t_range ) ).
