INTERFACE zsheep_if_client
  ...
  METHODS get
    RETURNING
      VALUE(result) TYPE zsheep_if_types=>ty_s_get.
  ...
  METHODS get_app
    ...
    RETURNING
      VALUE(result) TYPE REF TO zsheep_if_app.

  METHODS nav_app_leave
    IMPORTING
      VALUE(app)    TYPE REF TO zsheep_if_app OPTIONAL
    RETURNING
      VALUE(result) TYPE string.
  ...
  METHODS _event
    IMPORTING
      ...
      s_ctrl        TYPE zsheep_if_types=>ty_s_event_control OPTIONAL
  ...
  METHODS _bind
    IMPORTING
      ...
      custom_mapper TYPE REF TO zsheep_if_ajson_mapping OPTIONAL
      custom_filter TYPE REF TO zsheep_if_ajson_filter OPTIONAL
  ...
  METHODS _bind_edit
    IMPORTING
      val                TYPE data
      path               TYPE abap_bool  DEFAULT abap_false
      view               TYPE string     DEFAULT zsheep_if_client=>cs_view-main
      custom_mapper      TYPE REF TO zsheep_if_ajson_mapping OPTIONAL
      custom_mapper_back TYPE REF TO zsheep_if_ajson_mapping OPTIONAL
      custom_filter      TYPE REF TO zsheep_if_ajson_filter OPTIONAL
      custom_filter_back TYPE REF TO zsheep_if_ajson_filter OPTIONAL
      tab                TYPE data OPTIONAL
      tab_index          TYPE i    OPTIONAL
    RETURNING
      VALUE(result)      TYPE string.
